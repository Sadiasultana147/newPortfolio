    ...
    return (
        <div className="overflow-hidden body" data-aos="fade-down" data-aos-easing="linear"
            ...
            <div data-aos="fade-down" data-aos-easing="linear"
                ...
                <div className="col">
                    <img className="w-100 h-75" src="https://res.cloudinary.com/practicaldev/image/fetch/s--bjpVKHPe--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/i/8ogqpfkvqqpyfbs3w6p7.png" alt="" />
                </div>
                <div className="col">
                    <img className="w-100 h-75" src="https://1000logos.net/wp-content/uploads/2021/05/GitHub-logo.png" alt="" />
                </div>
            </div>
        </div>
    );
